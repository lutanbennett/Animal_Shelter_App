...
Manual verification by: Lutan Bennett — he tested the Contents list in a browser on 2026-09-24 (the release's only customer-facing change), the note and title were shown to him before the cut, and he approved by instructing the merge and deploy; line written by Claude at his request  Date: 2026-09-24
