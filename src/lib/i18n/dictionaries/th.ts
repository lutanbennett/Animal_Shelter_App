...
const th: Dictionary = {
  ...
  translations: {
    title: "คำแปล",
    subtitle:
      "ข้อความสาธารณะในอีกภาษาหนึ่ง ข้อความที่เจ้าหน้าที่เขียนหรือแก้ไขจะมารอที่นี่จนกว่าผู้จัดการจะเขียนหรือตรวจคำแปล คำแปลที่อนุมัติแล้วคือสิ่งที่ผู้อ่านภาษานั้นเห็น — ก่อนหน้านั้นจะเห็นต้นฉบับ",
