      ...
      topics: [
        ...
        },
        {
          ...
          steps: [
            ...
            "Save, then tap Publish — saving alone keeps the profile a draft, marked Draft on the card and in Management → Shelter Friends, and nothing appears on the website. If you are signed in and look at the Shelter Friends page while a draft is waiting, a note at the top says so. Once published, the card goes on the Shelter Friends page, which from then on is linked from the website's menu and footer, gets a thank-you band on the home page (the first five in your order, then a Your business here? tile) and a mention on the Donate page. Unpublish takes it down again; View on the website opens their card.",
    ...
    // ------------------------------------------------------------------
    {
      ...
      topics: [
        ...
        },
        {
          ...
          steps: [
            "Hero photo: the big photo beside the heading at the top of the home page. With none set, the heading and its buttons take the full width.",
