...
export default async function PublicResidentPage(
  ...
  const [residentsResult, photosResult] = await Promise.all([
    supabase
      ...
      .select(
        "id, name, species, breed, sex, size, ready_for_adoption, bio, temperament_notes, past_story_notes, profile_photo_drive_file_id, estimated_age_years, age_estimated_on, translations",
      )
      .eq("id", id)
      .limit(1)
